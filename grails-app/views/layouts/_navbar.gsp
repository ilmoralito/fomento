<ul class="nav nav-tabs">
  	...
  	<li class="${(actionName == 'deductions') ? 'active' : ''}"><g:link controller="deduction" action="deductions" params="[partner:partner.id, period:2013]">Deducciones de ${partner}</g:link></li>
