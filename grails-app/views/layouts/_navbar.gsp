<ul class="nav nav-tabs">
  	...
  	<li class="${(actionName == 'deductions') ? 'active' : ''}"><g:link controller="deduction" action="deductions" params="[partner:partner.id, period:fomento.currentYear()]">Deducciones de ${partner}</g:link></li>
